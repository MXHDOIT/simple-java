...
class FoodRatings {
    ...
    Map<String,Pair<Integer, String>> foodCuisineMap;
    //cuisine
    Map<String,TreeSet<Pair<Integer, String>>> cuisineMap;
    ...
    public FoodRatings(String[] foods, String[] cuisines, int[] ratings) {
        ...
        for(int i = 0;i < length;i++) {
            ...
            foodCuisineMap.put(food,new Pair<>(rating,cuisine));
            cuisineMap.computeIfAbsent(cuisine,k -> new TreeSet<>((a,b) -> !Objects.equals(a.getKey(), b.getKey()) ? b.getKey() - a.getKey() : a.getValue().compareTo(b.getValue())
            )).add(new Pair<>(rating, food));
        }
    }

    public void changeRating(String food, int newRating) {
        Pair<Integer, String> cuisine = foodCuisineMap.get(food);
        TreeSet<Pair<Integer, String>> treeSet = cuisineMap.get(cuisine.getValue());
        treeSet.remove(new Pair<>(cuisine.getKey(), food));
        treeSet.add(new Pair<>(newRating, food));
        foodCuisineMap.put(food,new Pair<>(newRating,cuisine.getValue()));
    }
